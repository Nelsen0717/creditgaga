...
function openSettings(){
  ...
  +'<div class="field"><label>'+esc(t('model'))+'</label><select id="stModel"><option value="claude-sonnet-5">Claude Sonnet 5 · '+(LANG==='zh'?'快':'fast')+'</option><option value="claude-fable-5-1">Claude Fable 5.1 · '+(LANG==='zh'?'最聰明':'smartest')+'</option><option value="claude-opus-5">Claude Opus 5</option><option value="claude-haiku-4-5-20251001">Claude Haiku 4.5 · '+(LANG==='zh'?'最快':'fastest')+'</option></select></div>'
